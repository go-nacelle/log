...
// PushHook adds a function to the end of hook queue. Each invocation of the
// DebugWithFields method of the parent MockLogger instance inovkes the hook
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// ErrorWithFields method of the parent MockLogger instance inovkes the hook
// at the front of the queue and discards it. After the queue is empty, the
// default hook function is invoked for any future action.
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// Fatal method of the parent MockLogger instance inovkes the hook at the
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// FatalWithFields method of the parent MockLogger instance inovkes the hook
// at the front of the queue and discards it. After the queue is empty, the
// default hook function is invoked for any future action.
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// InfoWithFields method of the parent MockLogger instance inovkes the hook
// at the front of the queue and discards it. After the queue is empty, the
// default hook function is invoked for any future action.
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// LogWithFields method of the parent MockLogger instance inovkes the hook
// at the front of the queue and discards it. After the queue is empty, the
// default hook function is invoked for any future action.
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// Sync method of the parent MockLogger instance inovkes the hook at the
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// Warning method of the parent MockLogger instance inovkes the hook at the
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// WarningWithFields method of the parent MockLogger instance inovkes the
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// WithFields method of the parent MockLogger instance inovkes the hook at
...
// stores the parameter and result values of this invocation.
func (m *MockLogger) WithIndirectCaller() log.Logger {
	r0 := m.WithIndirectCallerFunc.nextHook()()
	m.WithIndirectCallerFunc.appendCall(LoggerWithIndirectCallerFuncCall{r0})
	return r0
}
...
// method of the parent MockLogger instance is invoked and the hook queue is
// empty.
func (f *LoggerWithIndirectCallerFunc) SetDefaultHook(hook func() log.Logger) {
	f.defaultHook = hook
}

// PushHook adds a function to the end of hook queue. Each invocation of the
// WithIndirectCaller method of the parent MockLogger instance inovkes the
// hook at the front of the queue and discards it. After the queue is empty,
// the default hook function is invoked for any future action.
func (f *LoggerWithIndirectCallerFunc) PushHook(hook func() log.Logger) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *LoggerWithIndirectCallerFunc) nextHook() func() log.Logger {
	f.mutex.Lock()
	defer f.mutex.Unlock()
